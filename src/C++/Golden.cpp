...
void smith_waterman(string x1,string x2){
    ...
    ofstream myfile;
    myfile.open ("./verilog_version/out_1.dat",ios::out | ios::app);
    //myfile<< l1 <<"_"<<l2<<endl;
    stringstream ss; 
    ss << hex << biggest; 
    string res = ss.str(); 
...
void convertToBinary(string s)
{
    ...
    ofstream myfile;
    myfile.open ("./verilog_version/BinaryInput.dat",ios::out | ios::app);
    myfile << binaryS << endl;
    myfile.close();
    ...
    ofstream myfile2;
    myfile2.open ("./verilog_version/data_size.dat",ios::out | ios::app);
    myfile2 << res << endl;
    myfile2.close();
}
